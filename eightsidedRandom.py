...
class Random:
    ...
    # function returns a random integer (1, 2, 3, 4,5,6,7,8) according to a Catagorical distr. (8-sided dice)
    def eightsideddice(self, p=0.125, q=0.250, s=0.375, t=0.500, u=0.625, v=0.750, W=0.875):
        if s < 0. or s > 1.:
            return 1
